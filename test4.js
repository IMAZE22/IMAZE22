...
const obj = {
  ...
  "Web & app team": [
    { name: "Anubhav Shriwastava", info: "web coordinator" },
    { name: "Jyot Prajapati", info: "app coordinator" },
    { name: "Kandarp Shah", info: "web coordinator" },
  ],
  documentation: [
    { name: "Bhoomi Patel", info: "documentation head" },
    { name: "Hetvi Shah", info: "documentation head" },
  ],
  "Graphic design": [
  ...
  Decoration: [
    ...
    { name: "Vanshika Patel", info: "coordinator" },
